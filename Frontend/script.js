...
function signup(){
    ...
    axios.post('http://18.181.82.118/user/signup',{name: name, email:email, password:password})
    .then((response)=>{
...
function login(){
    ...
    axios.post('http://18.181.82.118/user/login',{email:email, password:password})
    .then((response) =>{
...
function sendEmail(){
    ...
    console.log(emailID)
    axios.post('http://18.181.82.118/password/forgotpassword', {emailID})
    .then(response=>{
