...
function downloadreport(){
    ...
    axios.get('http://18.181.82.118/premium/download', {headers: {"Authorization": token}})
    .then(response =>{
        console.log(response.data);
        getreports();
    })
...
function getreports(){
    ...
    axios.get('http://18.181.82.118/premium/getreport',{headers: {"Authorization": token}})
    .then(response=>{
...
function getmonthlyreport(){
    ...
    axios.get('http://18.181.82.118/expenses/getmonthlyreport', {headers: {"Authorization": token}})
    .then(response =>{
        console.log(response.data);
